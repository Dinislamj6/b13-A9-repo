      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="mt-4 max-w-xl">
            Your ultimate destination for sharing and discovering innovative ideas. Join our vibrant community and turn your ideas into reality!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mb-4 text-sm">
              Subscribe for exclusive idea updates and inspiration.
            </p>
